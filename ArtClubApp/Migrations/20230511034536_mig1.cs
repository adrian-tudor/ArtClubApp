        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Artworks_Payments_Payment_Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Admins_Payments_Payment_Id",
                        column: x => x.Payment_Id,
                        principalTable: "Payments",
                        principalColumn: "Payment_Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArtClub", x => x.Event_id);
                    table.ForeignKey(
                        name: "FK_ArtClub_Admins_admin_id",
                        column: x => x.admin_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contact_ArtClub_ArtClubEvent_id",
                        column: x => x.ArtClubEvent_id,
                        principalTable: "ArtClub",
                        principalColumn: "Event_id");
                });

            migrationBuilder.CreateIndex(
                name: "IX_Admins_ContactMessage_id",
                table: "Admins",
                column: "ContactMessage_id");

            migrationBuilder.CreateIndex(
                name: "IX_Admins_Payment_Id",
                table: "Admins",
                column: "Payment_Id");

            migrationBuilder.CreateIndex(
                name: "IX_ArtClub_admin_id",
                table: "ArtClub",
                column: "admin_id");

            migrationBuilder.CreateIndex(
                name: "IX_Artworks_Payment_Id",
                table: "Artworks",
                column: "Payment_Id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExhibitionHalls_Payment_Id",
                table: "ExhibitionHalls",
                column: "Payment_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Resources_Artwork_Id",
                table: "Resources",
                column: "Artwork_Id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Admins_Contact_ContactMessage_id",
                table: "Admins",
                column: "ContactMessage_id",
